...
// chicken!'
console.log(age > 100 ? 'Oh! So old!' : 'Still a spring chicken!');
...
console.log(name.length > 5 ? `Hi there ${name}!` : `Well hello ${name}`);
...
var planet = {name: "Earth", hasWater: true};
